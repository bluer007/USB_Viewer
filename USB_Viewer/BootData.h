...
unsigned char pbr_fat32_data[512] = {
	...
	0x20, 0x20, 0x46, 0x41, 0x54, 0x33, 0x32, 0x20, 0x20, 0x20,/*引导代码开始*/ 0xFA, 0xFC, 0xB6, /*后面一个字节表示该分区在分区表上的绝对顺序数*/0x01, 0x80, 0xFE,
...
unsigned char pbr_ntfs_data[2048] = {
	...
	0x00, 0x00, 0x00, 0x00, /*引导代码开始*/0xFA, 0xFC, 0xB6, 0x00, /*前面一个字节表示该分区在分区表上的绝对顺序数*/ 0x31, 0xC0, 0xBD, 0x00, 0x7C, 0x8E, 0xD0, 0x8D,
